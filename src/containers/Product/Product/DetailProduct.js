...
const DetailProduct = (props) => {
    ...
    const [arrDetailProduct, setArrDetailProduct] = useState([]);
    useEffect(() => {
        (async () => {
            try {
        ...
        (async () => {
            try {
                ...
                if (response && response.errCode === 0) {
                    setArrDetailProduct(response.data);
                }
            } catch (error) {
                console.log(error.message);
            }
                    ...
                    <div className="inner-content">
                        <div className="inner-detail">
                            <div className="inner-img">
                                <div className="preview">
                                    <span className="jqzoom">
                                        <img
                                            jqimg={arrDetailProduct.image}
                                            src={arrDetailProduct.image}
                                            alt={arrDetailProduct.name}
                                            title={arrDetailProduct.name}
                                        />
                                    </span>
                                </div>
                                        ...
                                        <ul>
                                            <li>
                                                <span>
                                                    <img
                                                        jqimg={
                                                            arrDetailProduct.image
                                                        }
                                                        src={
                                                            arrDetailProduct.image
                                                        }
                                                        alt={
                                                            arrDetailProduct.name
                                                        }
                                                        title={
                                                            arrDetailProduct.name
                                                        }
                            ...
                            <div className="inner-overview">
                                ...
                                <span>{arrDetailProduct.note}</span>
                            </div>
                        </div>

                        <div className="inner-desc">
                            {arrDetailProduct && !_.isEmpty(arrDetailProduct) && (
                                <div
                                    dangerouslySetInnerHTML={{
                                        __html: arrDetailProduct.descriptionHTML,
                                    }}
                                ></div>
                            )}
                        </div>
